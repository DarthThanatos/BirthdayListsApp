GuestHome.controller('GuestController', function GuestController($scope, Popeye) {
    ...
    $scope.suggest = function(){
        ...
        presentDialogOpen("Dodaj prezent", defaultPresent, '/present/')
    }
    ...
    $scope.accept = function(present) {
        document.getElementById(present.name + "-accept-text").hidden = false
        document.getElementById(present.name + "-accept-button").hidden = true
    }
